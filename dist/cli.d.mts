import { p as RunResult } from "./types-DUEIJGhR.mjs";

//#region node_modules/.pnpm/@commander-js+extra-typings@14.0.0_commander@14.0.3/node_modules/@commander-js/extra-typings/index.d.ts
...
declare function renderResult(result: RunResult, format: Exclude<OutputFormat, "text">, options?: RenderOptions): string;
//#endregion
export { OutputFormat, createProgram, renderResult, runCli };
